...
<p align="center">
  ...
  <img src="https://shields.io" alt="OOP Architecture">
  <img src="https://shields.io" alt="CLI Interface">
...
```mermaid
graph TD
    A[👤 ROOT OBJECT: Person] -->|Extends Identity & Age Biometrics| B[💼 OPERATIONAL LAYER: Employee]
    B -->|Extends Executive Power & Scope| C[👑 LEADERSHIP NODE: Manager]

    style A fill:#ff9999,stroke:#333,stroke-width:3px
    style B fill:#99ccff,stroke:#333,stroke-width:3px
    style C fill:#cc99ff,stroke:#333,stroke-width:3px
```
